...
### Adding a person: `add`
Adds a person to the address book and prints updated book<br>
...
Deletes the specified person from the address book and prints updated book. Irreversible.<br>
Format: `delete INDEX`
