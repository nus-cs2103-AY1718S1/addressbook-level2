...
### Finding all persons containing any keyword in their tags: `findtags`
...
Examples: 
* `findtags owesMoney`<br>
  Returns `owesMoney` but not `owesmoney`
* `findtags friends owesMoney secretive`<br>
  Returns Any person having tags `friends`, `owesMoney`, or `secretive`
