...
Examples: 
* `find John`<br>
  Returns `John Doe` but can also return `john` of any case
* `find Betsy Tim John`<br>
  Returns Any person having names `Betsy`, `Tim`, or `John`, regardless of case
...
Sorts the entries in ascending or descending order depending on ORDER parameter.<br>
Format: `sort ORDER`  
