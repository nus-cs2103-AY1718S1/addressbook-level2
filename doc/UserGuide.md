...
> ADDRESS must be in this format: a/BLOCK, STREET, UNIT, POSTAL_CODE
> be seen using the `viewall` command.
> 
> Persons can have any number of tags (including 0)

Examples: 
* `add John Doe p/98765432 e/johnd@gmail.com a/123, John street, #01-01, 133421`
* `add Betsy Crowe pp/1234567 e/betsycrowe@gmail.com pa/NA, Newgate Street, Newgate Prison, 144577 t/criminal t/friend`
