...
### Adding a person: `add`
Adds a person to the address book and the list of all persons in the addressbook will be shown<br>
...
Examples:
* `find John`<br>
  Returns `John Doe` both `john`
* `find Betsy Tim John`<br>
  Returns Any person having names `Betsy`, `Tim`, or `John`, without considering the cases.

### Deleting a person : `delete`
Deletes the specified person from the address book. Irreversible. The list of all persons in the addressbook will be shown<<br>
Format: `delete INDEX`
