...
### Adding a person: `add`
Adds a person to the address book and lists the Addressbook<br>
...
Deletes the specified person from the address book. Irreversible. Lists the Addressbook afterward.<br>
Format: `delete INDEX`
