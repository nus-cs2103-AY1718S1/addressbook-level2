...
### Finding all persons containing any keyword in their tag: `findtag`
Finds persons whose tags contain the keyword.<br>
...
Examples: 
* `find friend`<br>
  Returns `John Doe t/friend` but not `John Doe t/Friend`
