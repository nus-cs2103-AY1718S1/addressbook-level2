...
Sorts all entries in the address book according to a specified field.
If no field is specified, address book will be sorted by name.
<br>
Format: 'sort [FIELD]'
...
* `sort address`<br>
  Sorts address book by address
* `sort phone`<br>
  Sorts address book by phone
