...
### Adding a person: `add`
Adds a person to the address book and lists out all the people in the address book.<br>
...
Deletes the specified person and lists out all the remaining people in the address book.. Irreversible.<br>
Format: `delete INDEX`
