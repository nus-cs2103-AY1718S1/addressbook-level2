...
* Support for storing address (`a/`), gender (`g/`) and tags (`t/`)
...
Format: `add NAME g/GENDER [p]p/PHONE_NUMBER [p]e/EMAIL [p]a/ADDRESS [t/TAG]...` 
...
Examples: 
* `add John Doe g/Male p/98765432 e/johnd@gmail.com a/John street, block 123, #01-01`
* `add Betsy Crowe g/Female pp/1234567 e/betsycrowe@gmail.com pa/Newgate Prison t/criminal t/friend`
