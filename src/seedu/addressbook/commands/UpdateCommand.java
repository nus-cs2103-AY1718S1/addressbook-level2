...
public class UpdateCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Updates a person to the address book. "
            ...
            + " John Doe p/12345678 e/johnd@gmail.com a/311, Clementi Ave 2, #01-31 t/friends t/owesMoney";

    public static final String MESSAGE_SUCCESS = "Existing person updated: %1$s";
    ...
    public CommandResult execute() {
        try {
            ...
            return new CommandResult(MESSAGE_NOT_FOUND_PERSON);
        }
    }
}
