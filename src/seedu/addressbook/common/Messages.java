...
public class Messages {
    ...
    /* Login message */
    public static final String MESSSAGE_LOGIN = "Please login to use AddressB Book [Command: login]";
    /* Register message　*/
    public static final String MESSSAGE_REGISTER = "Welcome to registration panel!";
