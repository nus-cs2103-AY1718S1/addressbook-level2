...
public class Messages {
    ...
    public static final String MESSAGE_RANDOM_PERSON_OVERVIEW = "A random person was selected!";
    ...
    public static final String MESSAGE_EMPTY_LIST = "Address Book is Empty!";
}
