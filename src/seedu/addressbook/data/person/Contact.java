...
public class Contact {
  ...
  public Contact(
          String contact,
          boolean isPrivate,
          final String MESSAGE_CONTACT_CONSTRAINTS,
          final String CONTACT_VALIDATION_REGEX) throws IllegalValueException {
   ...
   */
  protected static boolean isValidContact(String test, final String CONTACT_VALIDATION_REGEX) {
