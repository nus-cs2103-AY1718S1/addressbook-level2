...
public class UniquePersonList implements Iterable<Person> {
    ...
    /**
     * Sort all persons in list by name. 1 for ascending and 0 for descending
     */
    public void sort(String option){
        if (option.equals("asc")){
            Collections.sort(internalList,Person.sortByNameASC);
        } else if (option.equals("dsc")){
            Collections.sort(internalList,Person.sortByNameDSC);
        } else {
