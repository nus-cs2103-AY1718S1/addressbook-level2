...
public class AddCommandTest {
    ...
    public void addCommand_invalidName_throwsException() {
        ...
        for (String name : invalidNames) {
            assertConstructingInvalidAddCmdThrowsException(name, Phone.EXAMPLE, true, Email.EXAMPLE, false,
                    Address.EXAMPLE, true, Birthday.EXAMPLE, false, EMPTY_STRING_LIST);
        }
    }
    ...
    public void addCommand_invalidPhone_throwsException() {
        ...
        for (String number : invalidNumbers) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, number, false, Email.EXAMPLE, true,
                    Address.EXAMPLE, false, Birthday.EXAMPLE, false, EMPTY_STRING_LIST);
        }
    }
    ...
    public void addCommand_invalidBirthday_throwsException() {
        final String[] invalidBirthday = {"", " ","30,30,200","3,20,10"};
        for (String birthday : invalidBirthday) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, Email.EXAMPLE, true,
                    Address.EXAMPLE, true, birthday, true, EMPTY_STRING_LIST);
        }
    }
    ...
    private void assertConstructingInvalidAddCmdThrowsException(String name, String phone,
        ...
        try {
            new AddCommand(name, phone, isPhonePrivate, email, isEmailPrivate, address, isAddressPrivate, birthday, isBirthdayPrivate,
                    tags);
