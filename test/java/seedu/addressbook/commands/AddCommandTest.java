...
public class AddCommandTest {
    ...
    public void addCommand_invalidName_throwsException() {
        ...
        for (String name : invalidNames) {
            assertConstructingInvalidAddCmdThrowsException(name, Phone.EXAMPLE, true, DOB.EXAMPLE, false, Email.EXAMPLE, false,
    ...
    public void addCommand_invalidPhone_throwsException() {
        ...
        for (String number : invalidNumbers) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, number, false, DOB.EXAMPLE, true, Email.EXAMPLE, true,
    ...
    public void addCommand_invalidAddress_throwsException() {
        ...
        for (String address : invalidAddresses) {
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, DOB.EXAMPLE, true, Email.EXAMPLE,
    ...
    public void addCommand_invalidTags_throwsException() {
        ...
        for (String[] tags : invalidTags) {
            ...
            assertConstructingInvalidAddCmdThrowsException(Name.EXAMPLE, Phone.EXAMPLE, true, DOB.EXAMPLE, false, Email.EXAMPLE,
    ...
    private void assertConstructingInvalidAddCmdThrowsException(String name, String phone,
            boolean isPhonePrivate, String dob, boolean isDOBPrivate, String email, boolean isEmailPrivate, String address,
            boolean isAddressPrivate, Set<String> tags) {
        try {
            new AddCommand(name, phone, isPhonePrivate, dob, isDOBPrivate, email, isEmailPrivate, address, isAddressPrivate,
                    tags);
        ...
        String error = String.format(
                ...
                name, phone, isPhonePrivate, dob, isDOBPrivate, email, isEmailPrivate, address, isAddressPrivate, tags);
        fail(error);
    }

    @Test
    public void addCommand_validData_correctlyConstructed() throws Exception {
        AddCommand command = new AddCommand(Name.EXAMPLE, Phone.EXAMPLE, true, DOB.EXAMPLE, true, Email.EXAMPLE, false,
                Address.EXAMPLE, true, EMPTY_STRING_LIST);
        ...
        assertEquals(DOB.EXAMPLE, p.getDOB().value);
