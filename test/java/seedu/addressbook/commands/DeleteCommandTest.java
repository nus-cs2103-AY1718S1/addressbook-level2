...
public class DeleteCommandTest {
    ...
    public void setUp() throws Exception {
        ...
        Person samDoe = new Person(new Name("Sam Doe"), new Gender("Male"),new Phone("63345566", false),
    ...
    public void execute_targetPersonNotInAddressBook_returnsPersonNotFoundMessage()
        ...
        Person notInAddressBookPerson = new Person(new Name("Not In Book"), new Gender("Female"), new Phone("63331444", false),
