...
public class UpdateCommandTest {
    ...
    @Test
    public void updateCommand_emptyAddressBook_addressBookNotExistPerson() {
        ...
        assertEquals(String.format(UpdateCommand.MESSAGE_NOT_FOUND_PERSON), result.feedbackToUser);
    }
