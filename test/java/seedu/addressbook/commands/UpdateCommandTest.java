...
public class UpdateCommandTest {
    ...
    @Test
    public void updateCommand_personNotFoundInAddressBook() {
        ...
        assertEquals(String.format(UpdateCommand.MESSAGE_PERSON_NOT_FOUND, p.getName()), result.feedbackToUser);
    }

    @Test
    public void updateCommand_sameInformationAsOriginal() throws Exception {
        Person p = TestUtil.generateTestPerson();
        AddressBook book = new AddressBook();
        book.addPerson(p);
        AddCommand addCommand = new AddCommand(p);
        UpdateCommand updateCommand = new UpdateCommand(p);
        ...
        assertEquals(UpdateCommand.MESSAGE_UNNECESSARY_UPDATE, result.feedbackToUser);
    }
}
