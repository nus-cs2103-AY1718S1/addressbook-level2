...
public class ParserTest {
    ...
    public void parse_addCommandInvalidArgs_errorMessage() {
        final String[] inputs = {
                ...
                // no phone prefix
                String.format("add $s $s e/$s r/$s a/$s", Name.EXAMPLE, Phone.EXAMPLE, Email.EXAMPLE, Race.EXAMPLE, Address.EXAMPLE),
                // no email prefix
                String.format("add $s p/$s $s r/$s a/$s", Name.EXAMPLE, Phone.EXAMPLE, Email.EXAMPLE, Race.EXAMPLE, Address.EXAMPLE),
                //no race prefix
                String.format("add $s p/$s e/$s $s a/$s", Name.EXAMPLE, Phone.EXAMPLE, Email.EXAMPLE, Race.EXAMPLE, Address.EXAMPLE),
                // no address prefix
                String.format("add $s p/$s e/$s r/$s $s", Name.EXAMPLE, Phone.EXAMPLE, Email.EXAMPLE, Race.EXAMPLE, Address.EXAMPLE)
        };
    ...
    public void parse_addCommandInvalidPersonDataInArgs_errorMessge() {
        ...
        final String invalidRaceArg = "r/not_alphabets";
        final String validRaceArg = "r/" + Race.EXAMPLE;
        ...
        final String[] inputs = {
                // invalid name
                String.format(addCommandFormatString, invalidName, validPhoneArg, validEmailArg, validRaceArg),
                // invalid phone
                String.format(addCommandFormatString, validName, invalidPhoneArg, validEmailArg, validRaceArg),
                // invalid email
                String.format(addCommandFormatString, validName, validPhoneArg, invalidEmailArg, validRaceArg),
                // invalid race
                String.format(addCommandFormatString, validName, validPhoneArg, validEmailArg, invalidRaceArg),
                // invalid tag
                String.format(addCommandFormatString, validName, validPhoneArg, validEmailArg, validRaceArg) + " " + invalidTagArg
        };
    ...
    private static String convertPersonToAddCommandString(ReadOnlyPerson person) {
        String addCommand = "add "
                ...
                + (person.getRace().isPrivate() ? " pr/" : " r/") + person.getRace().value
